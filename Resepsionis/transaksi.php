  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"> Konfirmasi Pemasanan</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          </div><!-- /.col -->
        </div><!-- /.row -->
            ...
            <div class="card-body">
             <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                INNER JOIN tb_kamar ON tb_transaksi.id_kamar =tb_kamar.id_kamar WHERE tb_transaksi.tgl_chek_in BETWEEN '".$_GET['dari']."' AND '".$_GET['ke']."' ";
                }else{
                $query = "SELECT * FROM tb_transaksi 
                INNER JOIN tb_tamu ON tb_transaksi.NIK= tb_tamu.NIK
